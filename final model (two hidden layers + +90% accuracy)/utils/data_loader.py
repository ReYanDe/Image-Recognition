"""Подготовка картинки по оттенкам серого"""
...
def random_img():
    while True:
        ...
        # для обучения использовать числа на районе до 5000
        secondN = random.randint(1, 5000)
        # для тестирования использовать числа на районе до 1000
        # secondN = random.randint(1, 1000)
